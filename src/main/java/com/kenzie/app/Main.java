...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        // attempt to put fruit
        FruitDTO fruitDTO = FruitHttpClient.createFruitDTO();
        String fruitJSON = fruitDTO.toJSON();
        System.out.println("Here is the response from attempting to put a fruit: ");
        System.out.println(fruitHttpClient.putFruit(fruitJSON, "https://www.fruityvice.com/api/fruit"));
    }
}
